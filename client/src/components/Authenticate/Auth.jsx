...
const Auth = () => {
  const { setIsModalOpen, setIsUserLoggedIn, hasAccount, setHasAccount } =
          ...
          <div className="auth-container__login">
            ...
            <button
              ...
              className={`login-with-google ${
                isUpdatingUser.google ? "loading-google-btn" : ""
              }`}
            >
              {isUpdatingUser.google ? (
                <FontAwesomeIcon
            ...
            <form action="login" onSubmit={handleLogin}>
              ...
              <button
                className={`login-btn ${
                  isUpdatingUser.email ? "loading--btn" : ""
                }`}
              >
                {isUpdatingUser.email ? (
                  <FontAwesomeIcon
                    className="loading--icon"
                    icon={faCircleNotch}
                    spin
        ...
        {hasAccount && (
          <div className="auth-container__signup">
            ...
            <button
              onClick={handleSignInWithGoogle}
              className={`login-with-google ${
                isUpdatingUser.gmail ? "loading-google-btn" : ""
              }`}
            >
              {isUpdatingUser.google ? (
                <FontAwesomeIcon

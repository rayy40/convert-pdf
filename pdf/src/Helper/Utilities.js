export const operationsBoxInfo = [
  {
    header: "Compress PDF",
    ...
    image: (
      <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ></path>
        <path
          d="M7.68718 7.68718L15.8787 9.73507L16 9.76539L16.1213 9.73507L24.3128 7.68718L22.2649 15.8787L22.2346 16L22.2649 16.1213L24.3128 24.3128L16.1213 22.2649L16 22.2346L15.8787 22.2649L7.68718 24.3128L9.73507 16.1213L9.76539 16L9.73507 15.8787L7.68718 7.68718Z"
          stroke="white"
        ></path>
      </svg>
    ),
  ...
  {
    header: "PPT to PDF",
    description: "Convert PowerPoint Pressentations to PDF documents",
    link: "ppt-to-pdf",
    image: (
  ...
  },
  {
    header: "PDF to JPG",
    description:
      "Extracting images from your PDF or save each page as a separate Image",
    link: "pdf-to-jpg",
    image: (
      <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    image: (
      <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="#0FC0C5"
        ></path>
        <path d="M11.5 9.5V6.5H20.5V9.5" stroke="white"></path>
